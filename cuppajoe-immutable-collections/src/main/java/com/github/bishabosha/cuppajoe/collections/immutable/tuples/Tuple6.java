...
import com.github.bishabosha.cuppajoe.higher.compose.Compose6;
import com.github.bishabosha.cuppajoe.higher.functions.Func6;
import com.github.bishabosha.cuppajoe.higher.unapply.Unapply6;
...
public final class Tuple6<A, B, C, D, E, F> implements Tuple, Unapply6<A, B, C, D, E, F>, Compose6<A, B, C, D, E, F> {
    ...
    @Override
    public <O> O compose(@NonNull Func6<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? extends O> mapper) {
        Objects.requireNonNull(mapper, "mapper");
        return mapper.apply($1, $2, $3, $4, $5, $6);
    }

    public <AA, BB, CC, DD, EE, FF> Tuple6<AA, BB, CC, DD, EE, FF> flatMap(@NonNull Func6<A, B, C, D, E, F, Tuple6<AA, BB, CC, DD, EE, FF>> mapper) {
        Objects.requireNonNull(mapper, "mapper");
        return mapper.apply($1, $2, $3, $4, $5, $6);
    }
