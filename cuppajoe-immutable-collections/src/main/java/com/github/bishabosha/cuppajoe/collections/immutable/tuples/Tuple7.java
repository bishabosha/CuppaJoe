...
import com.github.bishabosha.cuppajoe.higher.compose.Compose7;
import com.github.bishabosha.cuppajoe.higher.functions.Func7;
import com.github.bishabosha.cuppajoe.higher.unapply.Unapply7;
...
public final class Tuple7<A, B, C, D, E, F, G> implements Tuple, Unapply7<A, B, C, D, E, F, G>, Compose7<A, B, C, D, E, F, G> {
    ...
    @Override
    public <O> O compose(@NonNull Func7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends O> mapper) {
        Objects.requireNonNull(mapper, "mapper");
        return mapper.apply($1, $2, $3, $4, $5, $6, $7);
    }

    public <AA, BB, CC, DD, EE, FF, GG> Tuple7<AA, BB, CC, DD, EE, FF, GG>
    flatMap(@NonNull Func7<A, B, C, D, E, F, G, Tuple7<AA, BB, CC, DD, EE, FF, GG>> mapper) {
        Objects.requireNonNull(mapper, "mapper");
        return mapper.apply($1, $2, $3, $4, $5, $6, $7);
    }
