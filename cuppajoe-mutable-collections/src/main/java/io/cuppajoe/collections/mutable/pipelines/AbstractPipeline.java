...
package io.cuppajoe.collections.mutable.pipelines;

import io.cuppajoe.collections.mutable.base.AbstractBase;
...
class AbstractPipeline<T> extends AbstractBase<T> {
    ...
    private AbstractPipeline() {
        closeHandlers = new io.cuppajoe.collections.mutable.lists.LinkedList<>();
        isClosed = false;
    }
