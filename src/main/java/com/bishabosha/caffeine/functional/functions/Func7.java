...
import com.bishabosha.caffeine.functional.tuples.Apply7;
import com.bishabosha.caffeine.functional.tuples.Product7;
...
public interface Func7<A, B, C, D, E, F, G, R> {
    ...
    @Contract(pure = true)
    default Func1<Product7<A, B, C, D, E, F, G>, R> tupled() {
