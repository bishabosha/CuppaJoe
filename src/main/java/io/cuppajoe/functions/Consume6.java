...
public interface Consume6<A, B, C, D, E, F> {
    ...
    @Contract(pure = true)
    static <U, V, W, X, Y, Z> Func6<U, V, W, X, Y, Z, Try<Void>> lift(Consume6<? super U, ? super V, ? super W, ? super X, ? super Y, ? super Z> func) {
    ...
    @Contract(pure = true)
    default Consume1<Product6<A, B, C, D, E, F>> tupled() {
